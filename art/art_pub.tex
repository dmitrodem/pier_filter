...
\begin{figure}[h]
  \begin{tabular}{cc}
    \includegraphics{images/fig3a} & \includegraphics{images/fig3c}
    \\
    a) & c) \\
    & \\
    \includegraphics{images/fig3b} & \\
    b) & \\
  \end{tabular}
...
\begin{figure}[h]
  \begin{tabular}{cc}
    \includegraphics{images/fig4a} &
                                           \includegraphics{images/fig4b}
    \\
    a) & b) \\
  \end{tabular}
